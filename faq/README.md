...
## I want that a child element only changes when it's parent is hovered on, how do I do this?

```CSS
.parent:hover .child {
    /* do something different on the child element which only triggers when the parent is hovered */
